...
function jbdone() {
window.progress.innerHTML="Jailbreak done Mabrooook ya 3tawla";
goldhen();
}
function goldhen(){
...
<body>
    <h1 id=progress style='font-size:25px;text-align:center;text-shadow: 8px 8px 8px black;color:rgb(255, 255, 255);'></h1><br>
    <div id="loader" class="loader"></div>
    <div id="allset" class="info" style="display:none;font-size:30px;text-align:center;text-shadow: 8px 8px 8px rgb(255, 255, 255);color:rgb(255, 255, 255);">completed. Close the Browser!</div>
</body>
